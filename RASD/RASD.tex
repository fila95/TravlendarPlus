...
an event overlaps another event of another calendar nothing happen.
...
Apple) so that we can identify him/her by using his / her unique identifier.
...
\subsubsection{BuyTickets}
\begin{center}
\hspace*{-3.5cm}\includegraphics[scale=0.5]{images/SD/buyTicket}
\par\end{center}
...
The app will be available worldwide but since it is focused more on
Lombardy, transit information and search services (Enjoy, Mobike,
...
The system will be developed using a modular architecture that represents
an important aspect to make it more maintainable and stable.

The app and the server will be developed keeping a big eye on this
aspect.

\subsubsection{Portability}

Portability will be highly guaranteed by the fact that the app will
be distributed in multiple OS such as Android and iOS which represents
98\% of the smartphone market.
...
\begin{itemize}
\item Filippo Calzavara: 28.00h
\item Giovanni Filaferro: 28.00h
\item Benedetto Maria Nespoli: 28.00h
\end{itemize}
