...
\item {[}G6.4{]} Allow users to set the owned bike and/or bike sharing providers
\item {[}G6.5{]} Allow users to set a time range in which they can take
public transits
\item {[}G6.6{]} Allow users to set if they own a car and/or their favorite
car sharing providers
\item {[}G6.7{]} Allow users to set the preferred ride sharing service
\end{itemize}
\item {[}G7{]} Allow the users to create calendars
\begin{itemize}
\item {[}G7.1{]} Allow users to color calendar
\item {[}G7.2{]} Allow users to change calendar's color and name
\end{itemize}
...
\item 1.1.0 - Minor bug correction (23/11/2017)
\item 1.2.0 - Updated Class Diagram, Use Case and Sequence Diagram (25/11/2017)
\end{itemize}
...
\begin{center}
\hspace*{-3.0cm}\includegraphics[scale=0.45]{/Users/phil/git/CalzavaraFilaferroNespoli/RASD/images/CD}
\par\end{center}
...
\textbf{Active mode:}
\begin{center}
\includegraphics[scale=0.27]{/Users/phil/git/CalzavaraFilaferroNespoli/RASD/images/SC-active}
\par\end{center}

\textbf{Passive mode:}
\noindent \begin{center}
\hspace*{-2.0cm}\includegraphics[scale=0.36]{/Users/phil/git/CalzavaraFilaferroNespoli/RASD/images/SC-passive}
\par\end{center}
...
\subsubsection{Allow people to purchase transit ticket}

The ticket purchase can be implemented as SMS based system that sends
a purchasing request to the local transit company which reply to the
user's cell phone with the PNR code of the ticket. This choice of
designing was made to ensure compatibility among every transit provider
and to allow users to pay it by charging the cost of the ticket on
their cell phone credit/bill, letting the carrier provider handling
the payment.
...
region of Lombardy
\item Most public transits companies provide a sms-based purchasing system.
If they don't, their app will be opened to complete the purchase.
If the app is not available the company's website will be opened
...
of a cost-based one
\item Google Maps API takes into account strikes information
\end{enumerate}
...
\begin{center}
\includegraphics[scale=0.13]{images/Wireframe/2-HomeScr_wired@3x}\enskip{}\includegraphics[scale=0.13]{images/Wireframe/3-HomeScreenCalendarExpan_wired@3x}
\par\end{center}
...
In this view, car sharing service's cars or bike sharing bikes, or
means of transport derived by ride services will be shown on map.
The user will have the ability to launch the relative app to use that
service.
...
Mike was invited to John's Party in Barabiago and he really wants
...
Allow the user to buy public transportation tickets.
...
\tabularnewline
\hline 
Output conditions & The user has received a text message with the ticket PNR\tabularnewline
\hline 
Exceptions & \begin{itemize}
\item The purchased is aborted if the user doesn't have enough credit on
the phone
\item If the provider doesn't support the SMS purchasing, their app is opened
\item If the app is not available the company's website will be opened
\end{itemize}
\tabularnewline
\hline 
\end{tabular}
...
\subsubsection{BuyTickets SMS}
\begin{center}
\hspace*{-3.5cm}\includegraphics[scale=0.43]{images/SD/buyTicket}
\par\end{center}
...
\begin{itemize}
\item Filippo Calzavara: 32.00h
\item Giovanni Filaferro: 32.00h
\item Benedetto Maria Nespoli: 32.00h
\end{itemize}
