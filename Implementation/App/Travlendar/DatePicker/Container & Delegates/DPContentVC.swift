...
class DPContentVC: UIViewController, UIScrollViewDelegate {
    
    // MARK: - Properties
    unowned let datePickerView: DPView
    let scrollView: UIScrollView
    var presentedMonthView: MonthView
    var scrollDirection: DPScrollDirection = .none
    ...
    init(datePickerView: DPView, frame: CGRect, presentedDate: Date) {
