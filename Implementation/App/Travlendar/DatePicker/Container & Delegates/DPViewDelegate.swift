...
public protocol DPViewDelegate: class {
     ...
     */
    var firstWeekDay: DPWeekDay {get}
     ...
     */
    var selectionShape: DPSelectionShape { get }
    
    /**
     font of the date labels. Defaults to systemfont with a medium size.
     
     - Note: you can use any UIFont name you want, as long as it is available. If it's not available, DP will
     ...
     return DPFont(name: "AvenirNext-MediumItalic", size: .medium)
     }
     
     //set system font with custom size
     var fontForDayLabel: DPFont {
     return DPFont(name: "", size: .large)
     }
     
     ````
     */
    var fontForDayLabel: DPFont { get }
    ...
    /**
     ...
     ````
     */
    var fontForWeekDaysViewText: DPFont { get }
 ...
 */
public extension DPViewDelegate {
    
    public func didPresentOtherMonth(_ monthView: DPMonthView) {}
    ...
    public var firstWeekDay: DPWeekDay {
        
        if let calendarValue = DPWeekDay(rawValue: Calendar.current.firstWeekday){
    ...
    public var selectionShape: DPSelectionShape { return .circle }
    public var fontForDayLabel: DPFont { return DPFont() }
    ...
    public var fontForWeekDaysViewText: DPFont { return DPFont() }
