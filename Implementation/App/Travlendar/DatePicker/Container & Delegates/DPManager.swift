...
final class DPManager {
    
    // MARK: - Properties
    private var components: DateComponents
    private unowned let datePickerView: DPView
    ...
    /**
     ...
     an array holding dictionaries with the weekDayIndex as key and a DPDay object as value.
     The DPDay object holds the value (like 17) and a bool that determines that the day involved
     is included in the month or not.
     */
    func getMonthInfoForDate(_ date: Date) -> (monthStartDay: Date, monthEndDay: Date, numberOfWeeksInMonth: Int, weekDayInfo: [[Int:DPDay]]) {
        ...
        var weeksInMonthInformationToReturn = [[Int:DPDay]]()
        ...
        for weekIndex in 0..<numberOfWeeksInMonth {
            ...
            case 0:
                ...
                var weekInformationToReturn = [Int:DPDay]()
                ...
                for i in 0..<previousMonthDatesArray.count {
                    ...
                    let dayInPreviousMonth = DPDay(dayValue: dayInPreviousMonthValue, monthValue: previousMonthValue, yearValue: previousYearValue, isInMonth: false)
                ...
                for _ in 0..<amountOfFirstDays {
                    ...
                    let dayInWeek = DPDay(dayValue: dayInFirstWeekOfMonth, monthValue: monthValue, yearValue: yearValue, isInMonth: true)
            ...
            case numberOfWeeksInMonth - 1:
                ...
                for _ in 0..<amountOfLastDays {
                    ...
                    let dayInWeek = DPDay(dayValue: dayInLastWeekOfMonth, monthValue: monthValue, yearValue: yearValue, isInMonth: true)
                    weekInformationToReturn[dayOfWeekIndex] = dayInWeek
                    dayOfWeekIndex += 1
                    dayOfMonthIndex += 1
                }
                ...
                for i in 0..<nextMonthDatesArray.count {
                    ...
                    let dayInNextMonth = DPDay(dayValue: dayInNextMontValue, monthValue: nextMonthValue, yearValue: nextYearValue, isInMonth: false)
            ...
            default:
                ...
                for _ in 0...6 {
                    ...
                    let dayInWeek = DPDay(dayValue: dayInWeekOfMonth, monthValue: monthValue, yearValue: yearValue, isInMonth: true)
                    weekInformationToReturn[dayOfWeekIndex] = dayInWeek
                    dayOfWeekIndex += 1
                    dayOfMonthIndex += 1
